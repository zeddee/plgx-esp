...
# Platform: Linux x64
#
# Description: This is a sample script that can be used to delete services on
# Linux agent(s) via Polylogyx Endpoint Platform Server Response Action UI.
# Update string on line 18 to uniquely identify list of services on agent and
...
serviceList="myService1,myService2,myService3"

services=$(echo $serviceList | tr "," "\n")
