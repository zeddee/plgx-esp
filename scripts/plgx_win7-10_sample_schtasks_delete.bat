...
REM
REM Description: This is a sample script that can be used to delete a scheduled 
REM task on Windows agent(s) via Polylogyx Endpoint Platform Server Response 
REM Action UI. Update your task name on line 19 and proceed to the steps 
REM described below.
REM
