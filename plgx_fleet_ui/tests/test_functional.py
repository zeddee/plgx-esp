...
class TestEnrolling:
    ...
    def test_duplicate_host_identifier_when_not_expecting_unique_ids(self, node, testapp):
        ...
        testapp.app.config['POLYLOGYX_EXPECTS_UNIQUE_HOST_ID'] = False
...
class TestDistributedRead:
    ...
    def test_distributed_query_read_not_before(self, db, node, testapp):
        ...
        datetime_patcher = mock.patch.object(polylogyx.utils.dt, 'datetime',
        ...
        assert polylogyx.utils.dt.datetime.utcnow() != not_before
...
class TestRuleEndToEnd:
    ...
    def test_rule_end_to_end(self, db, node, app, testapp):
        ...
        from polylogyx.tasks import analyze_result
        ...
        with mock.patch.dict(app.config, {'POLYLOGYX_ALERTER_PLUGINS': {'dummy': ('fake', {})}}):
