...
from polylogyx.extensions import bcrypt, ldap_manager
...
class LoginForm(Form):
    ...
    def validate(self):
        ...
        if current_app.config['POLYLOGYX_AUTH_METHOD'] == 'polylogyx':
        ...
        elif current_app.config['POLYLOGYX_AUTH_METHOD'] == 'ldap':
        ...
        elif current_app.config['POLYLOGYX_AUTH_METHOD'] is None:
            return True
    ...
    def auth_method(self):
        return current_app.config['POLYLOGYX_AUTH_METHOD']

class ChangePasswordForm(Form):

    password = PasswordField('Existing Password', validators=[DataRequired()])
