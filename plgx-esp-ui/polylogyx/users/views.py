...
from polylogyx.extensions import csrf, ldap_manager, login_manager



from polylogyx.models import User, HandlingToken, db
from polylogyx.utils import flash_errors
from polylogyx.blueprints.external_api import *
...
def login():
    ...
    if current_app.config['POLYLOGYX_AUTH_METHOD'] not in (None, 'polylogyx', 'ldap'):
