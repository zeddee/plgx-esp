...
CREATE TABLE file (path TEXT, directory TEXT, filename TEXT, inode BIGINT, uid BIGINT, gid BIGINT, mode TEXT, device BIGINT, size BIGINT, block_size INTEGER, atime BIGINT, mtime BIGINT, ctime BIGINT, btime BIGINT, hard_links INTEGER, symlink INTEGER, type TEXT, attributes TEXT,volume_serial TEXT,file_id TEXT);
...
CREATE TABLE groups (gid BIGINT, gid_signed BIGINT, groupname TEXT,group_sid TEXT,comment TEXT);
...
CREATE TABLE interface_details (dns_server_search_order TEXT,dns_host_name TEXT,dns_domain_suffix_search_order TEXT,dns_domain TEXT,dhcp_server TEXT,dhcp_lease_obtained TEXT,dhcp_lease_expires TEXT,dhcp_enabled INTEGER,service TEXT,speed INTEGER,physical_adapter INTEGER,enabled INTEGER,connection_status TEXT,connection_id TEXT,manufacturer TEXT,description TEXT, friendly_name TEXT,interface TEXT, mac TEXT, type INTEGER, mtu INTEGER, metric INTEGER, flags INTEGER, ipackets BIGINT, opackets BIGINT, ibytes BIGINT, obytes BIGINT, ierrors BIGINT, oerrors BIGINT, idrops BIGINT, odrops BIGINT, collisions BIGINT, last_change BIGINT);
...
CREATE TABLE os_version (name TEXT, version TEXT, major INTEGER, minor INTEGER, patch INTEGER, build TEXT, platform TEXT, platform_like TEXT, codename TEXT,install_date TEXT);
...
CREATE TABLE pci_devices (subsystem_model TEXT,subsystem_model_id TEXT,subsystem_vendor TEXT,subsystem_vendor_id TEXT,pci_subclass TEXT,pci_subclass_id TEXT,pci_class_id TEXT,pci_slot TEXT, pci_class TEXT, driver TEXT, vendor TEXT, vendor_id TEXT, model TEXT, model_id TEXT);
...
CREATE TABLE process_open_sockets (pid INTEGER, fd BIGINT, socket BIGINT, family INTEGER, protocol INTEGER, local_address TEXT, remote_address TEXT, local_port INTEGER, remote_port INTEGER, path TEXT,net_namespace TEXT);
CREATE TABLE processes (cpu_subtype INTEGER,cpu_type INTEGER,uppid BIGINT,upid BIGINT,pid BIGINT, name TEXT, path TEXT, cmdline TEXT, state TEXT, cwd TEXT, root TEXT, uid BIGINT, gid BIGINT, euid BIGINT, egid BIGINT, suid BIGINT, sgid BIGINT, on_disk INTEGER, wired_size BIGINT, resident_size BIGINT, total_size BIGINT, user_time BIGINT, system_time BIGINT, disk_bytes_read BIGINT, disk_bytes_written BIGINT, start_time BIGINT, parent BIGINT, pgroup BIGINT, threads INTEGER, nice INTEGER);
...
CREATE TABLE routes (hopcount INTEGER,destination TEXT, netmask INTEGER, gateway TEXT, source TEXT, flags INTEGER, interface TEXT, mtu INTEGER, metric INTEGER, type TEXT);
...
CREATE TABLE users (uid BIGINT, gid BIGINT, uid_signed BIGINT, gid_signed BIGINT, username TEXT, description TEXT, directory TEXT, shell TEXT, uuid TEXT,type TEXT);
