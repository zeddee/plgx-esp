...
from polylogyx.plugins.alerters.pagerduty import PagerDutyAlerter
from polylogyx.plugins.alerters.sentry import SentryAlerter
from polylogyx.plugins.alerters.slack import SlackAlerter
...
class TestEmailerAlerter:
    def setup_method(self, _method):
        ...
        self.config = {
            ...
            'subject_prefix': '[PolyLogyx Fleet Test]',
            'enroll_subject_prefix': '[PolyLogyx Fleet Test]',
        }
    ...
    def test_will_email_on_rule_match(self, node, rule, testapp):
        ...
        expected_subject = '[PolyLogyx Fleet Test] {host_identifier} {name} ({action})'.format(
