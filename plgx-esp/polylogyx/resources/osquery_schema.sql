...
CREATE TABLE atom_packages (name TEXT, version TEXT, description TEXT, path TEXT, license TEXT, homepage TEXT);
...
ALTER TABLE certificates ADD sid TEXT;
ALTER TABLE certificates ADD store_location TEXT;
ALTER TABLE certificates ADD store TEXT;
ALTER TABLE certificates ADD username TEXT;
ALTER TABLE certificates ADD store_id TEXT;
CREATE TABLE chocolatey_packages (name TEXT, version TEXT, summary TEXT, author TEXT, license TEXT, path TEXT);
CREATE TABLE chrome_extensions (uid BIGINT, name TEXT, profile TEXT, identifier TEXT, version TEXT, description TEXT, locale TEXT, update_url TEXT, author TEXT, persistent INTEGER, path TEXT, permissions TEXT);
...
ALTER TABLE file ADD product_version TEXT;
...
ALTER TABLE groups ADD is_hidden INTEGER;
...
ALTER TABLE logged_in_users ADD sid TEXT;
ALTER TABLE logged_in_users ADD registry_hive TEXT;
...
ALTER TABLE process_events ADD syscall TEXT;
...
ALTER TABLE users ADD is_hidden INTEGER;
