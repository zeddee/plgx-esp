...
from polylogyx.utils import extract_results, quote


class LogPlugin(AbstractLogsPlugin):
    def __init__(self, config):
        append = config.setdefault('POLYLOGYX_LOG_FILE_PLUGIN_APPEND', True)
        status_path = config.get('POLYLOGYX_LOG_FILE_PLUGIN_STATUS_LOG')
        result_path = config.get('POLYLOGYX_LOG_FILE_PLUGIN_RESULT_LOG')
